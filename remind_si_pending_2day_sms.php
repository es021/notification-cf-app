...
define("REMINDER_TYPE","remind_si_pending_2day_sms");
define("SMS_TYPE", "INTERVIEW_PENDING_REMINDER_2DAY");
...
foreach ($data as $d) {
    ...
    SendEmail::insert($keyId, REMINDER_TYPE, json_encode($d), "SMS", $DB);
}
